...
Naming a file isn't grounding. Produce the traced model `pstack-how` prescribes. If the design redefines ownership or layering, also run the **why** skill on the existing shape so the rationale becomes a constraint, not a guess.
